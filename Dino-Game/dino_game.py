...
class BG:
    ...
    def set_texture(self):
        path = os.path.join("Dino-Game/resources/images/bg.png")
...
class Dino:
    ...
    def set_texture(self):
        path = os.path.join(f"Dino-Game/resources/images/dino{self.texture_num}.png")
        self.texture = pygame.image.load(path)
        self.texture = pygame.transform.scale(self.texture, (self.width, self.height))

    def set_sound(self):
        path = os.path.join("Dino-Game/resources/sounds/jump.wav")
...
class Cactus:
    ...
    def set_texture(self):
        path = os.path.join("Dino-Game/resources/images/cactus.png")
        self.texture = pygame.image.load(path)
        self.texture = pygame.transform.scale(self.texture, (self.width, self.height))
...
class Score:
    ...
    def show(self):
        ...
        screen.blit(self.lbl, (winWidth - lbl_width - 10, 10))

    def set_sound(self):
        path = os.path.join("Dino-Game/resources/sounds/point.wav")
        self.sound = pygame.mixer.Sound(path)
...
class Game:
    ...
    def set_sound(self):
        path = os.path.join("Dino-Game/resources/sounds/die.wav")
        self.sound = pygame.mixer.Sound(path)
    ...
    def over(self):
        ...
        screen.blit(
            self.big_lbl,
            (winWidth // 2 - self.big_lbl.get_width() // 2, winHeight // 4),
        )
        screen.blit(
            self.small_lbl,
            (winWidth // 2 - self.small_lbl.get_width() // 2, winHeight // 2),
        )
        self.playing = False
    ...
    def spawn_cactus(self):
        if len(self.obstacles) > 0:
            ...
            x = random.randint(
                ...
                winWidth + prev_cactus.x + self.dino.width + 84,
            )

        else:
            x = random.randint(winWidth + 100, 1000)
